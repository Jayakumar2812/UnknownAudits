...
contract Recommended is BEP20("MockGovToken", "MGToken") {
    ...
    /**
     * @notice implementing votes tracking
     * @dev Overriding the internal _transfer function to implement votes tracking
     */
    ...
    /**
     * @notice implementing votes tracking
     * @dev Overriding the public mint(uint256 amount) function from ERC20 to implement votes tracking
     */
